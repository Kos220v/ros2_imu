"""Питоновское зеркало бинарного протокола IMU для тестового приложения Windows
(держится в синхроне с ros2/imu_stm32_bridge/imu_stm32_bridge/protocol.py;
проверка: tests/test_windows_protocol_mirror.py).
